...
\setminted{
    ...
    bgcolor=LightGray,
    style=tango,
    fontfamily=tt, % Evitá sans-serif tipo "Comic Sans"
    % commentstyle=\color{gray!80}\ttfamily\itshape % Más sobrio y académico
}
...
\director{Ariel Marquez}
\codirector{Zoe Prieto}
\carrera{Proyecto Integrador de la Carrera de Ingeniería Nuclear}
\grado{Estudiante}
\laboratorio{Departamento de Física de Reactores y Radiaciones}
\jurado{Edmundo Lopasso \\ 
Norberto Schmidt}
